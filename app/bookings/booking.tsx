    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { color: theme.colors.text }]}>Book Vehicle</Text>
        ...
        >
          ...
          <View style={styles.vehicleInfo}>
            <Text style={[styles.vehicleName, { color: theme.colors.text }]}>{vehicle.name}</Text>
        ...
        <View style={styles.form}>
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Rental Period</Text>
          ...
          <View style={styles.dateRow}>
            ...
            <View style={styles.dateField}>
              <Text style={[styles.label, { color: theme.colors.textSecondary }]}>Start Time</Text>
              <TextInput
                style={[
                  styles.input,
                  {
          ...
          <View style={styles.dateRow}>
            <View style={styles.dateField}>
              <Text style={[styles.label, { color: theme.colors.textSecondary }]}>End Date *</Text>
              <TextInput
                style={[
                  styles.input,
                  {
            ...
            <View style={styles.dateField}>
              <Text style={[styles.label, { color: theme.colors.textSecondary }]}>End Time</Text>
              <TextInput
                style={[
                  styles.input,
                  {
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Locations</Text>
          ...
          <View style={styles.fieldContainer}>
            <Text style={[styles.label, { color: theme.colors.textSecondary }]}>Dropoff Location</Text>
            <TextInput
              style={[
                styles.input,
                {
        ...
        >
          <Text style={[styles.summaryTitle, { color: theme.colors.text }]}>Price Summary</Text>
          <View style={styles.summaryRow}>
            <Text style={[styles.summaryLabel, { color: theme.colors.textSecondary }]}>Daily Rate</Text>
            <Text style={[styles.summaryValue, { color: theme.colors.text }]}>
              {formatCurrency(vehicle.pricePerDay)}
            </Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={[styles.summaryLabel, { color: theme.colors.textSecondary }]}>Estimated Duration</Text>
            <Text style={[styles.summaryValue, { color: theme.colors.text }]}>2 days</Text>
          </View>
